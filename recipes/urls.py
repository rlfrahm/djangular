...
# from .views import RecipeListView, RecipeDetailView, FoodConversionListView, RecipeEdit
from . import views


urlpatterns = patterns('recipes.views',
   # url(r'^old$', RecipeListView.as_view(), name="recipe-home"),
   url(r'^/(?P<slug>[-\w]+)/$', views.RecipeDetailView, name="recipe-detail"),
   url(r'^', views.RecipeListView, name="recipe-list"),
   # url(r'^edit$', RecipeEdit.as_view(), name="recipe-edit"),
