    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.ForeignKey(related_name='ingredients', blank=True, to='recipes.Direction', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, to='recipes.Category', null=True)),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='+', blank=True, to='recipes.Unit', null=True),
        ),
        migrations.AddField(
            model_name='food',
            name='group',
        ...
        migrations.AddField(
            ...
            name='recipe',
            field=models.ForeignKey(related_name='directions', to='recipes.Recipe'),
        ),
    ]
